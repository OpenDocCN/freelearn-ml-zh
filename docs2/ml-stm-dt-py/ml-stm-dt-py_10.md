...
你可以在 GitHub 上找到本书的所有代码，链接如下：[`github.com/PacktPublishing/Machine-Learning-for-Streaming-Data-with-Python`](https://github.com/PacktPublishing/Machine-Learning-for-Streaming-Data-with-Python)。如果你还不熟悉 Git 和 GitHub，下载笔记本和代码示例的最简单方法是以下：
...
如果你还不熟悉 Python 环境，我建议你检查 Anaconda（[`www.anaconda.com/products/individual`](https://www.anaconda.com/products/individual)），它自带 Jupyter Notebook 和 JupyterLab，这两个都是执行笔记本的绝佳选择。它还包含了 Spyder 和 VSCode，用于编辑脚本和程序。

如果你安装 Python 或相关程序有困难，你可以查看 Google Colab ([`colab.research.google.com/`](https://colab.research.google.com/)) 或 Kaggle 笔记本 ([`www.kaggle.com/code`](https://www.kaggle.com/code))，这两个都允许你免费在线运行 Python 代码，无需任何设置。
...
![公式 _08_001](img/Formula_08_001.jpg)
...
如果你想要更深入和更多的例子，你可以查看以下有洞察力的文章：[`www.researchgate.net/publication/337581742_Machine_learning_for_streaming_data_state_of_the_art_challenges_and_opportunities`](https://www.researchgate.net/publication/337581742_Machine_learning_for_streaming_data_state_of_the_art_challenges_and_opportunities)。
...
+   [`arxiv.org/pdf/1911.10107.pdf`](https://arxiv.org/pdf/1911.10107.pdf)

+   [`cslt.riit.tsinghua.edu.cn/mediawiki/images/a/aa/07407387.pdf`](http://cslt.riit.tsinghua.edu.cn/mediawiki/images/a/aa/07407387.pdf)
...
+   [`arxiv.org/abs/1601.00667`](https://arxiv.org/abs/1601.00667)

+   [`rbcdsai.iitm.ac.in/blogs/finding-influencers-in-social-networks-reinforcement-learning-shows-the-way/`](https://rbcdsai.iitm.ac.in/blogs/finding-influencers-in-social-networks-reinforcement-learning-shows-the-way/)
...
+   [`arxiv.org/ftp/arxiv/papers/1901/1901.00569.pdf`](https://arxiv.org/ftp/arxiv/papers/1901/1901.00569.pdf)

+   [`www.ingentaconnect.com/contentone/ist/ei/2017/00002017/00000019/art00012?crawler=true&mimetype=application/pdf`](https://www.ingentaconnect.com/contentone/ist/ei/2017/00002017/00000019/art00012?crawler=true&mimetype=application/pdf)
...
+   [`arxiv.org/abs/1709.02349`](https://arxiv.org/abs/1709.02349)

+   [`arxiv.org/pdf/1908.10331.pdf`](https://arxiv.org/pdf/1908.10331.pdf)
...
+   [`arxiv.org/pdf/1912.10944.pdf`](https://arxiv.org/pdf/1912.10944.pdf)
...
![图 8.5 – 前一个代码块的结果图](img/B18335_08_5.jpg)
...
![图 8.6 – 前一个代码块生成的图表](img/B18335_08_6.jpg)
...
1.  现在我们来执行模型。我们首先将`past_state`设置为 0，将`past_action`设置为`buy`。总奖励初始化为 0，并实例化一个奖励累加列表。
...
![图 8.7 – 上一代码块生成的图表](img/B18335_08_7.jpg)
...
![图 8.8 – 上一代码块生成的热力图](img/B18335_08_8.jpg)
...
+   强化学习应用: [`neptune.ai/blog/reinforcement-learning-applications`](https://neptune.ai/blog/reinforcement-learning-applications)

+   Q-learning: [`zh.wikipedia.org/wiki/Q-learning`](https://zh.wikipedia.org/wiki/Q-learning)

+   深度 Q-learning: [`zh.wikipedia.org/wiki/深度强化学习`](https://zh.wikipedia.org/wiki/深度强化学习)
